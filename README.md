...
- #### Что такое компаньон объекты в Kotlin?
...
- #### Преимущество использования `const` в Kotlin
...
- #### Приостанавливающие vs Блокирующие в Kotlin Корутинах
...
- #### Как выбрать между `apply` и `with`?
...
- #### Что такое контекст? Зачем он используется?
...
- #### Что такое модификатор `transient`?
  Модификатор `transient` используется для исключения полей класса из сериализации.
...
- #### Когда вы делаете значение объекта final?
